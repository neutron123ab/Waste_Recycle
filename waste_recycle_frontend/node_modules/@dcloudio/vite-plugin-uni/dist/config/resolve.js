...
const customResolver = (updatedId, importer) => {
    const utsModuleFile = (0, uni_cli_shared_1.resolveUtsModule)(updatedId, importer ? path_1.default.dirname(importer) : process.env.UNI_INPUT_DIR, process.env.UNI_UTS_PLATFORM);
    if (utsModuleFile) {

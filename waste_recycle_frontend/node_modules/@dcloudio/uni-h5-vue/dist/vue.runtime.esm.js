...
function emit$1(instance, event, ...rawArgs) {
    ...
    if (handler) {
        callWithAsyncErrorHandling(handler, instance, 6 /* ErrorCodes.COMPONENT_EVENT_HANDLER */, 
        // fixed by xxxxxx
    ...
    if (onceHandler) {
        ...
        callWithAsyncErrorHandling(onceHandler, instance, 6 /* ErrorCodes.COMPONENT_EVENT_HANDLER */, 
        // fixed by xxxxxx
...
function onBeforeActivate(hook, target) {
    registerKeepAliveHook(hook, "ba" /* LifecycleHooks.BEFORE_ACTIVATE */, target);
}
function onActivated(hook, target) {
    registerKeepAliveHook(hook, "a" /* LifecycleHooks.ACTIVATED */, target);
}
function onBeforeDeactivate(hook, target) {
    registerKeepAliveHook(hook, "bda" /* LifecycleHooks.BEFORE_DEACTIVATE */, target);
}

...
exports.compileKotlin = exports.parseKotlinPackage = exports.createKotlinResolveTypeReferenceName = void 0;
...
exports.parseKotlinPackage = parseKotlinPackage;
async function compileKotlin(filename) {
    ...
    if (process.env.NODE_ENV === 'production') {
        (0, utils_1.genUTSPlatformResource)(filename, utsPlatformOptions);
    }
    else if (process.env.NODE_ENV === 'development') {
        const kotlinFile = (0, utils_1.resolveUTSPlatformFile)(filename, utsPlatformOptions);
        // 开发模式下，需要生成 dex

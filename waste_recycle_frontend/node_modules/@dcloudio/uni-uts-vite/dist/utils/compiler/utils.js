...
exports.resolveUTSPlatformFile = exports.resolveAndroidDir = exports.genUTSPlatformResource = exports.resolvePackage = exports.getUtsCompiler = void 0;
...
function resolvePackage(filename) {
    ...
    if (index > -1) {
        return {
            ...
            name: (0, shared_1.camelize)(parts[index + 1]),
        };
    }
}
